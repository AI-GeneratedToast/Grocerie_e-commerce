          ...
          <MDBContainer className="my-5">
            ...
            <MDBRow className='g-0'>
                ...
                <MDBCardBody className='d-flex flex-column'>
                    ...
                    <h5 className="fw-normal my-4 pb-3" style={{letterSpacing: '1px'}}>Create a Brand New Account</h5>

                    <MDBInput name='email' onChange={e => {setEmail(e.target.value)}} required wrapperClass='mb-4' label='Email address' id='formControlLg' type='email' size="lg"/>
                    <p className='text-danger ' name='emailError'>{emailError}</p>
                    <MDBInput name='password' onChange={e => {setPassword(e.target.value)}} required  wrapperClass='mb-4'  label='Password' id='formControlLg' type='password' size="lg"/>
                    <p className=' text-danger' name='passwordError'>{passwordError}</p>

                    <MDBBtn className="mb-4 px-5" color='dark' size='lg'>Create Account</MDBBtn>
